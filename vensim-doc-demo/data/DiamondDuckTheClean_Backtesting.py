"""
Python model 'DiamondDuckTheClean_Backtesting.py'
...
def historical_urban_land():
    return np.interp(
        ...
        [150000, 158000, 166000, 173000, 178000, 181700],
    )
...
def expected_population():
    """
    Expected Population Exogener Bevölkerungspfad des Modells. Die Bevölkerung wird nicht mehr endogen durch Geburten, Todesfälle und Migration berechnet. Diese Lookup-Tabelle gibt die erwartete Bevölkerung für den Simulationszeitraum vor.
    """
    return np.interp(
        time_for_lookup(),
        [2000.0, 2005.0, 2010.0, 2015.0, 2020.0, 2025.0],
        [4.25e08, 4.35e08, 4.41e08, 4.47e08, 4.48e08, 4.52e08],
    )
